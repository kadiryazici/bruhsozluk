...
// export interface GetLikesResponse extends Pick<GetUserResponse, 'entries'> && {}

export type GetLikesEntries = Pick<GetUserResponse, 'entries'>;
export type GetLikesResponse = GetLikesEntries & PageResponse;
